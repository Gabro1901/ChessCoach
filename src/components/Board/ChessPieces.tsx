...
// Inline Cburnett vector pieces (Zero HTTP requests, zero broken image icons, instant render)
const WhitePawn: React.FC<{ className?: string }> = ({ className }) => (
...
const BlackPawn: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <path
      fill="#000"
      stroke="#000"
...
const WhiteRook: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
...
const BlackRook: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
...
const WhiteKnight: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
...
const BlackKnight: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const WhiteBishop: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackBishop: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const WhiteQueen: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fill="#fff" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackQueen: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
      <g stroke="none">
...
const WhiteKing: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const BlackKing: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg">
    <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const PIECE_COMPONENTS: Record<string, React.FC<{ className?: string }>> = {
  wp: WhitePawn,
  wn: WhiteKnight,
  wb: WhiteBishop,
  wr: WhiteRook,
...
export const ChessPiece: React.FC<PieceProps> = ({ type, color, className = 'w-full h-full' }) => {
  ...
  const Component = PIECE_COMPONENTS[pieceKey];

  if (!Component) return null;

  return (
    <div className={`${className} select-none pointer-events-none drop-shadow-md transition-transform duration-100 flex items-center justify-center`}>
